...
eval_env = Monitor(eval_env, "./logs/student_no_kd_eval_monitor.csv")

# Set up TensorBoard logger
logger = configure("./logs/tensorboard_student_no_kd_eval/", ["tensorboard"])

# Load trained student model (no KD)
model_path = "./models/ur5_student_no_kd_final.zip"
...
n_eval_episodes = 100
log_path = "./logs"
eval_csv_path = os.path.join(log_path, "student_no_kd_eval_metrics.csv")
eval_metrics = []
...
print(f"\nStudent Model (No KD) Evaluation over {n_eval_episodes} episodes:")
